      ...
      <div className="space-y-10">
        ...
        <section className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
            ...
            {/* Card 2 */}
            <div className="border border-teal-100 rounded-lg p-4 relative overflow-hidden">
              <div className="flex flex-col h-full">
                <h3 className="font-semibold text-teal-800">Network Security</h3>
                <p className="text-sm text-teal-700 mt-1">Ransomware Added in the Last 3 Months</p>
                <div className="mt-auto pt-4 flex justify-between items-center">
                  <Button variant="link" className="text-teal-600 p-0 h-auto text-sm flex items-center">
                    Explore & Simulate
                    <span className="ml-1">→</span>
                  </Button>
